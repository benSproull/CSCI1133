...
def invert(img_matrix):
    ...
    for y in range(height):
        for x in range(width):
            ...
            red = img_matrix[x][y][0]
            green = img_matrix[x][y][1]
            blue = img_matrix[x][y][2]
            new_red = int(255 - red)
            new_green = int(255 - green)
            new_blue = int(255 - blue)
            #new_color = (255 - red, 255 - green, 255 - blue)
            img_matrix[y][x] = [new_red,new_green,new_blue]
